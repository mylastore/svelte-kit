...
var Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_theme();
  return `<div class="${escape(null_to_empty($theme === "dark" ? "hero-bg-dark" : "hero-bg"), true) + " svelte-pojoeq"}"><div class="${"container"}"><div class="${"center svelte-pojoeq"}">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}
...
//# sourceMappingURL=_page.svelte-XUZ64QGV.js.map
