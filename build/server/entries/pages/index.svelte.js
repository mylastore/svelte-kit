import { c as create_ssr_component, a as subscribe, e as escape, h as null_to_empty, v as validate_component } from "../../chunks/index-b9650e14.js";
...
const css = {
  code: ".center.svelte-pojoeq{padding:50px 0\n  }.tagline.svelte-pojoeq{margin-top:5px}.hero-bg.svelte-pojoeq{background:#d3d6d9;background:radial-gradient(34.14% 72.25% at 47.58% 31.75%, rgba(232, 244, 255, .52) 0, rgba(255, 255, 255, 0) 100%), linear-gradient(92.4deg, #d1d4d7 14.67%, rgba(238, 247, 255, .48) 54.37%, rgba(206, 216, 224, .62) 92.49%), linear-gradient(0deg, #dbe7ef, #dbe7ef);position:relative;height:200px}.hero-bg-dark.svelte-pojoeq{background-color:#2B2A31;background-image:linear-gradient(315deg, #3c3b46 0%, #1e1e25 74%);position:relative;height:200px}.blogs.svelte-pojoeq{margin-top:20px}",
  map: null
};
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_theme();
  return `<div class="${escape(null_to_empty($theme === "dark" ? "hero-bg-dark" : "hero-bg")) + " svelte-pojoeq"}"><div class="${"container"}"><div class="${"center svelte-pojoeq"}">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}
      <div class="${"tagline svelte-pojoeq"}">Simple starter template to build svelte apps</div></div></div></div>

<div class="${"container"}"><div class="${"row blogs svelte-pojoeq"}"><div class="${"col-md"}"><div class="${"card mb-3"}"><img src="${"img/1.webp"}" width="${"550"}" height="${"368"}" class="${"card-img-top img-fluid"}" alt="${"mountains"}">
    ...
    <div class="${"col-md"}"><div class="${"card mb-3"}"><img src="${"img/1.webp"}" width="${"550"}" height="${"368"}" class="${"card-img-top img-fluid"}" alt="${"mountains"}">
