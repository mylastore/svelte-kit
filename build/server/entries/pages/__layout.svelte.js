import { c as create_ssr_component, a as subscribe, e as escape, v as validate_component } from "../../chunks/index-b9650e14.js";
import { s as session, p as page } from "../../chunks/stores-dcfa43fa.js";
import "../../chunks/Noti.svelte_svelte_type_style_lang-f300181f.js";
import "js-cookie";
import { v as variables } from "../../chunks/variables-86731e6d.js";
import { t as theme } from "../../chunks/themeStore-ec2129b8.js";
import { N as Noti } from "../../chunks/Noti-a1c7b9e5.js";
import "fetch-ponyfill";
import "../../chunks/index-fea78b38.js";
const browser = false;
var bootstrap = "";
var app = "";
const Gighub = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme();
  $$unsubscribe_page();
  return `<nav class="${"navbar navbar-expand-lg navbar-light " + escape($theme === "dark" ? "navbar-dark bg-dark" : "navbar-light bg-light")}"><div class="${"container"}"><a class="${"navbar-brand a-link"}" href="${"/"}">${escape(variables.appName)}</a>
    ...
    $page.url.pathname === `user/profile/${user.username}` ? "active" : ""
  ].join(" ").trim()}" href="${"#"}" id="${"navbarDropdown"}" role="${"button"}" data-bs-toggle="${"dropdown"}" aria-expanded="${"false"}">${escape(user.username)}</a>
                        <ul class="${"dropdown-menu dropdown-menu-end " + escape($theme === "dark" ? "dropdown-menu-dark" : "")}" aria-labelledby="${"navbarDropdown"}"><li><a class="${[
...
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_theme();
  return `${$theme && browser ? `<div class="${"site"}">${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}
